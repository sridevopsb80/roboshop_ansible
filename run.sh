...
# ansible-playbook \
#     -i "$1".dev.sridevops.site, \
#     -e env=dev \
#     -e ansible_user=ec2-user \
#     -e ansible_password=DevOps321 \
#     -e role_name="$1" main.yml \
#     -e vault_token="$2" 
...
# template folder is used for those services since we want the value to be carried over. 
# files folder can not be used for these services since it is used with copy module and it will not pass the variable value.
